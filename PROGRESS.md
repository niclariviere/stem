...
Resume: Nic funds the parked mainnet address (~0.3 SOL) + provides a personal recipient wallet → ~15 min to first REAL mainnet mint of his own song (the artifact for the Ulli talk). Full member-facing mainnet gated on T10 custodial wallet + automatic queue worker. Validate minting's worth via Ulli + founding members, not theory.
